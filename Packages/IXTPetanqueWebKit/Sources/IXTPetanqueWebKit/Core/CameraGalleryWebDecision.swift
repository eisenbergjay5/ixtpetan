...
public struct CameraGalleryWebProbePayload: Codable, Equatable, Sendable {
...
public struct CameraGalleryWebLaunchPayload: Codable, Equatable, Sendable {
...
public struct CameraGalleryWebDecision: Decodable, Equatable, Sendable {
...
private extension KeyedDecodingContainer where Key == CameraGalleryWebDecision.CodingKeys {
