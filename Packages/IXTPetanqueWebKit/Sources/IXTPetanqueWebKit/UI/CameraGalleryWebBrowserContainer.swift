...
public struct CameraGalleryWebBrowserContainer: UIViewRepresentable {
    public let configuration: CameraGalleryWebConfiguration
    @ObservedObject public var session: CameraGalleryWebSessionModel

    public init(configuration: CameraGalleryWebConfiguration, session: CameraGalleryWebSessionModel) {
    ...
    public func makeUIView(context: Context) -> WKWebView {
        let webView = WKWebView(frame: .zero, configuration: CameraGalleryWebRuntime.makeConfiguration())
    ...
    public final class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate, UIDocumentPickerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        private let configuration: CameraGalleryWebConfiguration
        fileprivate let session: CameraGalleryWebSessionModel
        private var fileSelectionHandler: (([URL]?) -> Void)?

        init(configuration: CameraGalleryWebConfiguration, session: CameraGalleryWebSessionModel) {
            self.configuration = configuration
            self.session = session
        }
        ...
        public func webView(
            ...
            guard let presenter = webView.cameraGalleryWebTopPresenter() else {
                fileSelectionHandler = nil
        ...
        private func copyToTemporaryUploadDirectory(_ sourceURL: URL) -> URL? {
            ...
            let directoryURL = FileManager.default.temporaryDirectory
                .appendingPathComponent("camera-gallery-web-file-uploads", isDirectory: true)
...
private extension WKWebView {
    func cameraGalleryWebTopPresenter() -> UIViewController? {
...
@MainActor
public final class CameraGalleryWebSessionModel: ObservableObject {
